...
void PatternConfigPage::on_kcfg_Editor_ClothCountUnits_activated(int index)
{
    ...
    if (clothCountTypeSelected == Configuration::EnumEditor_ClothCountUnits::Default) {
        clothCountTypeSelected = (QLocale::system().measurementSystem() == QLocale::MetricSystem) ? Configuration::EnumEditor_ClothCountUnits::Centimeters
    ...
    if (m_currentDocumentUnitsIndex != documentUnitsTypeSelected) {
        ...
        case Configuration::EnumDocument_UnitsFormat::Stitches:
            ...
            case Configuration::EnumDocument_UnitsFormat::Inches:
                if (m_currentClothCountUnitsIndex
                    == Configuration::EnumEditor_ClothCountUnits::Centimeters) { // from stitches to inches with cloth count in centimeters
                    documentWidth /= 2.54;
                    documentHeight /= 2.54;
                }
            ...
            case Configuration::EnumDocument_UnitsFormat::Centimeters:
                if (m_currentClothCountUnitsIndex
                    == Configuration::EnumEditor_ClothCountUnits::Inches) { // from stitches to centimeters with cloth count in inches
                    documentWidth *= 2.54;
                    documentHeight *= 2.54;
                }
        ...
        case Configuration::EnumDocument_UnitsFormat::Inches:
            ...
            case Configuration::EnumDocument_UnitsFormat::Stitches:
                ...
                if (m_currentClothCountUnitsIndex
                    == Configuration::EnumEditor_ClothCountUnits::Centimeters) { // from inches to stitches with cloth count in centimeters
                    documentWidth *= 2.54;
                    documentHeight *= 2.54;
                }
        ...
        case Configuration::EnumDocument_UnitsFormat::Centimeters:
            ...
            case Configuration::EnumDocument_UnitsFormat::Stitches:
                ...
                if (m_currentClothCountUnitsIndex
                    == Configuration::EnumEditor_ClothCountUnits::Inches) { // from centimeters to stitches with cloth count in inches
                    documentWidth /= 2.54;
                    documentHeight /= 2.54;
                }
...
void PatternConfigPage::setClothCountPrecision()
{
    if (m_currentClothCountUnitsIndex == Configuration::EnumEditor_ClothCountUnits::Default) {
        m_currentClothCountUnitsIndex = (QLocale::system().measurementSystem() == QLocale::MetricSystem)
