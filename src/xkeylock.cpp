...
/**
  @file
  Used to provide the status of the keyboard LEDs.
  The original file was taken from keybled-0.65.tar.gz by Aurelien Jarno.
  This version is reduced in scope to those functions required for KXStitch
  */
